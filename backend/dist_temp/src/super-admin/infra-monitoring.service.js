...
var InfraMonitoringService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.InfraMonitoringService = void 0;
...
let InfraMonitoringService = InfraMonitoringService_1 = class InfraMonitoringService {
    constructor(prisma, syncGateway) {
        this.prisma = prisma;
        this.syncGateway = syncGateway;
        this.logger = new common_1.Logger(InfraMonitoringService_1.name);
    }
    async getOverview() {
        let dbStatus = 'UP';
        try {
    ...
    async getDbMonitor() {
        try {
            const [connectionsRaw, activeRaw, dbSizeRaw, tablesRaw] = await Promise.all([
            ...
            const [businesses, orders, products, auditLogs, devices, subscriptions, users, staff, payments, syncQueues, categories, customers, expenses, paymentQrs] = await Promise.all([
    ...
    async getContainers() {
        ...
        try {
            const dockerOutput = (0, child_process_1.execSync)('docker ps --format "{{.ID}}\t{{.Names}}\t{{.Status}}"', { timeout: 2000, encoding: 'utf-8' });
    ...
    async getRealtimeLogs(filter, search, limit = 50) {
    ...
    async getDeployments() {
        ...
        try {
            commitHash = (0, child_process_1.execSync)('git rev-parse --short HEAD', { timeout: 1000, encoding: 'utf-8' }).trim();
        }
        catch (e) { }
        return {
            currentVersion: '1.2.0-enterprise',
...
exports.InfraMonitoringService = InfraMonitoringService;
exports.InfraMonitoringService = InfraMonitoringService = InfraMonitoringService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        sync_gateway_1.SyncGateway])
], InfraMonitoringService);
//# sourceMappingURL=infra-monitoring.service.js.map